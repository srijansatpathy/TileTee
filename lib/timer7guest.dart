...
class Launch7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime kd = now.add(Duration(minutes: 84));
      ...
      child: MaterialApp(
        ...
        home: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('LEVEL SEVEN', style: TextStyle(fontFamily: 'Manrope', fontWeight: FontWeight.bold),),backgroundColor: Colors.black,
          ),
          body: Stack(
            children: [
              Padding(
