...
class Launch4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime twen = now.add(Duration(minutes: 20));
    ...
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: Text('LEVEL FOUR', style: TextStyle(fontFamily: 'OpenSans', fontWeight: FontWeight.bold),),backgroundColor: Colors.black,
          ),
          body: Stack(
            children: [
              Padding(
