...
class Launch6 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime thir = now.add(Duration(minutes: 72));
      ...
      child: MaterialApp(
        ...
        home: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('LEVEL SIX', style: TextStyle(fontFamily: 'Manrope', fontWeight: FontWeight.bold),),backgroundColor: Colors.black,
          ),
          body: Stack(
            children: [
              Padding(
